...
namespace Notes.Aplication.Notes.Commands.CreateNote
{
    public class CreateNoteCommandHandler : IRequestHandler<CreateNoteCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(CreateNoteCommand request, CancellationToken cancellationToken)
        {
            ...
            await _dbContext.Notes.AddAsync(note, cancellationToken); //добавление созданной заметки в контекст
            await _dbContext.SaveChangesAsync(cancellationToken); // сохранение изменений в контексте
